...
You have a persistent Persistent Agent Memory directory at `/workspaces/loofi-fedora-tweaks/.claude/agent-memory/architecture-advisor/`. Its contents persist across conversations.
