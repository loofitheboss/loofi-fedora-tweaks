---
name: Arkitekt
description: Architecture and code structure expert for Loofi Fedora Tweaks v33.0.0. Designs features, plans code organization, and ensures architectural consistency.
