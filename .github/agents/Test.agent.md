---
name: Test
description: Testing specialist for Loofi Fedora Tweaks v44.0.0. Creates comprehensive unit tests following project conventions with proper mocking of system calls.
