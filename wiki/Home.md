...
**Current Version**: v43.0.0 "Stabilization-Only"
...
- **Comprehensive test suite**: 5878 passing, 35 skipped, 82.33% coverage
...
- **[Changelog](Changelog)** — Version history highlights from v25.0.0 to v43.0.0
...
- **Latest Release**: [v43.0.0](https://github.com/loofitheboss/loofi-fedora-tweaks/releases/tag/v43.0.0)
...
- **Latest Stable**: v43.0.0 "Stabilization-Only" (February 2026)
- **Python**: 3.12+
- **Framework**: PyQt6
- **Platform**: Fedora 43+
- **License**: MIT
