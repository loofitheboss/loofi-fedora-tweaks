...
Fedora review enforcement release — new checker (`scripts/check_fedora_review.py`), workflow runner gate for write-mode `package`/`release`, and required `fedora_review` job in CI/auto-release pipelines.
