...
class ReposTab(QWidget):
    def __init__(self):
        ...
        # Placeholder command
        self.btn_copr_loofi.clicked.connect(lambda: self.run_command("pkexec", ["dnf", "copr", "enable", "-y", "loofitheboss/loofi-fedora-tweaks"], self.tr("Enabling Loofi COPR...")))
    ...
    def enable_rpm_fusion(self):
        ...
        """
        self.run_command("pkexec", ["sh", "-c", cmd], self.tr("Enabling RPM Fusion repositories..."))
    ...
    def install_multimedia_codecs(self):
        ...
        self.run_command("pkexec", ["sh", "-c", cmd], self.tr("Installing Multimedia Codecs..."))

    def enable_flathub(self):
        self.run_command("flatpak", ["remote-add", "--if-not-exists", "flathub", "https://flathub.org/repo/flathub.flatpakrepo"], self.tr("Enabling Flathub..."))
